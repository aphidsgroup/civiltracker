...
export default async function MobileSitesPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] pb-28 select-none">
      {/* HEADER */}
      <div className="bg-gradient-to-br from-[#1a0a00] via-[#7a3310] to-[#fc6e20] text-white px-5 pt-6 pb-10 rounded-b-[32px] shadow-lg shadow-[#fc6e20]/20 relative overflow-hidden">
