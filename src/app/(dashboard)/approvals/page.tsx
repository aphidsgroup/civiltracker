    ...
    <div className="flex flex-col gap-5.5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
        {[
          ...
          { label: 'Pending Value', value: formatCurrency(stats.pendingAmount), sub: 'Total pipeline cash', color: 'text-[#fc6e20]' },
        ].map((c) => (
          ...
          return (
            <Link
              ...
              className={`px-3.5 py-1.5 rounded-full text-xs font-bold no-underline whitespace-nowrap transition-all ${
                isActive
                  ? 'bg-[#fc6e20] text-white shadow-sm'
                      ...
                      <tr key={app.id} className="hover:bg-slate-50/50 transition-colors">
                        <td className="px-4 py-3">
                          ...
                          {app._count.comments > 0 && (
                            <span className="inline-flex items-center gap-1 text-[11px] text-[#fc6e20] font-semibold mt-0.5">
                ...
                items={approvals.map((app) => ({
                  ...
                  meta: (
                    <div className="flex justify-between items-center mt-1.5">
                      ...
                      <Link href={`/approvals/${app.id}`} className="inline-flex items-center gap-1 text-xs font-bold text-[#fc6e20] no-underline">
