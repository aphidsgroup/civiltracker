...
import { createSubcontractorAction } from '@/actions/subcontractors'
...
export default async function NewSubcontractorPage() {
  ...
  if (gate.status === 'denied') exitDeniedPage(gate, '/subcontractors/new')
    ...
    <div className="min-h-screen bg-gray-50/50">
      ...
      <div className="p-6 max-w-2xl">
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          <form action={createSubcontractorAction}>
